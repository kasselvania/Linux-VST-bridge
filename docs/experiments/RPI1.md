...
- restored-state editor with physical playing: **INCOMPLETE; ONE TERMINAL
  ...
  THERMAL LIMITING**
- RPI1 live callback readout: **INSTALLED AND PHYSICALLY READ DURING AN
  EDITOR-CLOSED PIGMENTS SESSION; COOLED EDITOR CAMPAIGN NOT RUN**
- RPI1 causal phase observer: **INSTALLED AND PHYSICALLY CAPTURED WITH A
  BOUNDED HISTORY HOLE DISCLOSED; X DAMAGE IDLE SMOKE CHECKED; COOLED
  EDITOR CAMPAIGN NOT RUN**
