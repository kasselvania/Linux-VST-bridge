...
|---|---|---|---|---|
| FL Studio 26.1.5.5618 (trial) | unqualified for completed musical workflow | Same FL workspace across schema-1 clean uninstall and schema-2 reinstall; runner `proton-11.0-2c-fl-crypt32-order-v1`; [WD0 Deck result](../evidence/wd0/deck-trial-2026-09-25.md) | Exact manager-owned reinstall and new operation with old install/uninstall history retained; version-matched FL executable; normal managed launch and confirmed cohort retirement; saved `.flp` file present. Operator later reported hearing stock playback, without a retained audio receipt. WD1 below establishes partial direct Serum use. | WAV export lacks a retained result; selected audio backend unknown; licensed FLP recall deferred by trial mode |
| Serum 2.1.5 hosted directly in FL Studio (trial) | unqualified for complete WD1 workflow | Exact official installer SHA `507b726d97bf78920157f3817aff003b9ee38ee961f4efd318cf43216370f695`; same FL workspace and runner; [WD1 Deck result](../evidence/wd1/deck-serum-direct-2026-09-25.md) | Manager-owned product installation and exact module digest; operator reports FL discovery, audible piano-roll pattern, preset change, and working parameter automation. Normal close retired the exact FL cohort with zero owned processes and confirmed cleanup. Native bridge DSP remains zero. | WAV export not tested by operator choice; fresh-session use pending; oversized editor reduced through Serum logo menu; FLP recall not claimed |
