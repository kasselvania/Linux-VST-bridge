...
AudioProcessorLeaseResult AudioProcessorInterfaceLease::acquire_and_retire(bool pre_setup_census) {
...
ComponentAdmissionResult admit_component(Steinberg::IPluginFactory* factory,
    ...
    if (result.initialize_succeeded && component != nullptr) {
        ...
        result.audio_processor = lease.acquire_and_retire(pre_setup_census);
