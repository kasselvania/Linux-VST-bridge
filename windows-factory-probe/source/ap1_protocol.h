...
enum Kind:uint16_t {Hello=1,Ready=2,Process=3,Done=4,Close=5,Closed=6,Error=7,Activate=8,Activated=9,Start=10,Started=11,Stop=12,Stopped=13,Deactivate=14,Deactivated=15};
