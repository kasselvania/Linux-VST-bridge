...
The operator initially said 256 felt the same as 512, then corrected the listening impression: 256 felt snappier. This is a subjective observation, not a measured analog latency result. No matched wet-path loopback delay was established, so the shorter JACK period is not claimed to make Digitalis nearly imperceptible. The combined reported vendor and bridge buffering remains 6,144 frames, or 128 ms at 48 kHz; this is a buffer accounting observation, not a measured analog round-trip time.
