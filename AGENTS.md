...
A product-contract change requires the normal selection/design/review/approval path.
...
Do not use an acceptance transaction as the edit/compile/debug loop.
