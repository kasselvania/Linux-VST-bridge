...
SOURCE = '19b9ff917782ae9ca1f028d53fb6f8ca3902af13'
BUILD = 'f57d26d242a1e08ee20908acdb438c7061aae405'
TREE = '62628c88b65fb254f8c3405d6d001a8a1a7d0e68'
ZIP = 'f52eb7f6abc4af55a818d8235336ddc24afc46a3f10a39ec79eb516027b77a5d'
...
def generate(census, native, archive, output):
    ...
    manifest=dict(schema='linux-vst-bridge-ap18-host-source/v1',source_head=SOURCE,commit=BUILD,tree=TREE,
        ci_run=34661367087,artifact_id=10287109206,artifact_zip_sha256=ZIP,binaries=binaries,
    ...
    p=dict(schema=1,id='arturia-pigments',revision=7,claim='review_candidate',module_sha256=c['module']['sha256'],factory_vendor=c['factory_vendor'],
        **{'class':m},role='instrument',requirements=dict(runner=dict(id=runner['id'],version=runner['version'],
        ...
        evidence=['docs/AP18.md','evidence/ap18/pigments/installed.json','evidence/ap18/pigments/census.json','evidence/ap18/pigments/native-activation.json','evidence/ap18/pigments/event-output-operational-census.json','evidence/ap18/pigments/event-output-correction.json','evidence/ap18/pigments/retained-editor.json'])
