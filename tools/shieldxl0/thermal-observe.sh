...
usage() {
  printf 'usage: %s --seconds 60..3600 --shield-airflow obstructed|not-obstructed|unknown --cooling none|external-airflow|active-cooler --output DIRECTORY\n' "$0" >&2
  exit 2
}
