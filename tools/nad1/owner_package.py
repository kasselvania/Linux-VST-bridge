...
SOURCES={n:'tools/nad1/'+n for n in ('owner_package.py','owner_campaign.py','owner_supervise.py','service_fixture.cpp','application_fixture.cpp','application_supervise.py','application_campaign.py','lifetime_campaign.py','recovery_campaign.py','child_memory.h','child_memory_campaign.py')}
