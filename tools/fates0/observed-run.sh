...
usage() {
  printf 'usage: %s --label SAFE_LABEL --board-airflow obstructed|not-obstructed|unknown --cooling none|external-airflow|active-cooler --output DIRECTORY -- COMMAND [ARG...]\n' "$0" >&2
  exit 2
}
