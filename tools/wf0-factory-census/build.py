...
from common import (
    AP4_BRANCH as DX0_BRANCH, AP4_WINDOWS_BUILD_PATHS as AP1_WINDOWS_BUILD_PATHS, DX0_HOST_ARTIFACT_SCHEMA, DX0_HOST_BUILD_SCHEMA, DX0_HOST_MODE,
    AP4_REF as DX0_REF, DX0_WINDOWS_BUILD_INPUT_SCHEMA, ap4_complete_source as dx0_complete_source,
    dx0_identity_sha256, dx0_source_role, ap4_windows_build_input as dx0_windows_build_input,
)
from verify import (
...
def build_dx0_workflow(source_commit: str, sdk: pathlib.Path,
    ...
    call_surface = scanner_component_call_surface(repo_root(), ap0=True, ap2=True, ap4=True)
