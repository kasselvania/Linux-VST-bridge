...
from common import (
    AP3_BRANCH as DX0_BRANCH, AP1_WINDOWS_BUILD_PATHS, DX0_HOST_ARTIFACT_SCHEMA, DX0_HOST_BUILD_SCHEMA, DX0_HOST_MODE,
    AP3_REF as DX0_REF, DX0_WINDOWS_BUILD_INPUT_SCHEMA, ap3_complete_source as dx0_complete_source,
    dx0_identity_sha256, dx0_source_role, ap3_windows_build_input as dx0_windows_build_input,
)
from verify import (
