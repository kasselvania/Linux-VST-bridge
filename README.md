...
512 frames remains selected/supported/recommended; 256 remains unqualified. Short delivery gaps (#72) and FRAGMENTS rendering (#80) remain limitations. ASC/Pigments are outside this transition and have not been executed. Ordinary Deck transition and focused final smoke evidence are pending; no final acceptance completion is claimed by this source checkpoint. PR #92 remains open and unmerged for focused rereview.
